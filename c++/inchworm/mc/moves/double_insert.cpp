...
namespace inchworm::moves {
  ...
  scalar_t double_insert::attempt() {
    ...
    prop_config  = data.config; // we first copy last accepted config before proposing the new double_insert
    ...
    if (not prop_config.try_double_insert(d1_dag, d1, d2_dag, d2)) return 0;
