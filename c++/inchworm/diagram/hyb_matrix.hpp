...
namespace inchworm::diagram {
  ...
  struct hyb_matrix_t {
    ...
    template <typename R> scalar_t extract_det(R const &list_of_indices) const;
  ...
  template <typename R> scalar_t hyb_matrix_t::extract_det(R const &list_of_indices) const {
