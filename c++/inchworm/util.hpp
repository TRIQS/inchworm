...
namespace inchworm {
  ...
  /**
     * @param ad_full atom_diag of the full Hamiltonian H = H_loc + H_bath + H_hyb.
     * @param ad_loc  atom_diag of the local Hamiltonian H_loc.
     * @param ad_bath atom_diag of the bath Hamiltonian H_bath (in the full basis).
     * @param beta inverse temperature.
     * @param tau 0 < tau < beta.
     * @return The partial sum matrix of a function H. The result is a block diagonal matrix, with blocks and indices in the same order as in ad_loc.
     */
