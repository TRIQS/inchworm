...
\begin{align}
U(\tau, \beta)=& \frac{1}{\ZB} \operatorname{Tr_B} [e^{-(\beta-\tau) H_B } e^{-\tau H }] 
\\
\ZB =& \operatorname{Tr_B} [e^{-\beta H_B }] 
\end{align}

In interaction representation, where $H=H_B+H_\text{loc}+H_\text{hyb}$. The expansion is done on $H_\text{hyb}$
\begin{align}
U(\tau, \beta)=& \frac{1}{\ZB} \operatorname{Tr_B} [e^{-(\beta - \tau) H_B } e^{-\tau (H_B + H_{loc} + H_\text{hyb}) }]  
\\ 
...
\begin{align}
U(\tau,\beta)=& \frac{1}{\ZB}\sum_{k=0}^{\infty}   \int_{0}^{\beta} d \tau_{1} \cdots \int_{\tau_{k-1}}^{\beta} d \tau_{k} \int_{0}^{\beta} d \tau_{1}^{\prime} \cdots \int_{\tau_{k-1}^{\prime}}^{\beta} d \tau_{k}^{\prime} \\
...
\begin{align}
U(\beta)=& \frac{1}{\ZB}\sum_{k=0}^{\infty}  \int_{0}^{\beta} d \tau_{1} \cdots \int_{\tau_{k-1}}^{\beta} d \tau_{k} \int_{0}^{\beta} d \tau_{1}^{\prime} \cdots \int_{\tau_{k-1}^{\prime}}^{\beta} d \tau_{k}^{\prime} \\
& \times \sum_{j_1^{(\prime)} \cdots j_k^{(\prime)}} \sum_{p_1^{(\prime)} \cdots  p_k^{(\prime)}} 
\theta_{p_{1}}^{j_{1}} \theta_{p_{1}^{\prime}}^{j_{1}^{\prime}*} \cdots \theta_{p_{k}}^{j_{k}} \theta_{p_{k}^{\prime}}^{j_k^{\prime}*} \\
...
\begin{align}
Z_{\mathrm{B}}=\operatorname{Tr} e^{-\beta H_{\mathrm{B}}}=\prod_{\sigma} \prod_{p}^k \left(1+e^{-\beta \epsilon_{p}}\right)
\end{align}
...
This section discuss about the omitted part $w_{hyb}$, which is essentially just the connected terms of the determinant $\text{det} \Delta$. 
...
\begin{align}
  U^0_{00}(\tau_{m}) &= U^0_{11}(\tau_{m}) = e^{-\tau_{m} H_{loc}} = 1
  \\
  U^1_{00}(\tau_{m}) &= 
  \int_{0}^{\beta} d \tau_a 
