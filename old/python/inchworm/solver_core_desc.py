...
c.add_method("""void normalize (inchworm::scalar_t normalization_cte)""",
             doc = r"""""")
...
c.add_member(c_name = "errs_frame",
             c_type = "std::vector<scalar_t>",
             read_only= True,
             doc = r"""Last obtained frame error block-resolved""")
...
c.add_member(c_name = "Delta_tau",
             c_type = "inchworm::hyb_tau_t",
             read_only= True,
             doc = r"""""")

c.add_member(c_name = "Delta_tau_ED",
             c_type = "std::optional<hyb_tau_t>",
             read_only= False,
             doc = r"""""")

c.add_member(c_name = "Delta_tau_tilde",
             c_type = "inchworm::hyb_tau_t",
             read_only= True,
             doc = r"""""")
...
c.add_member(c_name = "frame_zeroth_order",
             c_type = "inchworm::frame_t",
             read_only= True,
             doc = r"""The zeroth order frame of the last sampling method""")
...
c.add_member(c_name = "n_bath_sites_ED",
             c_type = "int",
             initializer = """ 0 """,
             doc = r"""Discrete number of sites per block in Delta_tau used to approximate the bath""")
